Script: recon.sh
Autor: Arturo Mata [JØKΣR] <arturo.mata@gmail.com>
Version: 1.0.0
...
$ sudo chmod 755 recon.sh

# Editar el archivo

Aun en el directorio < var/log > se escribe la siguiente línea de código < ls -l > y se despliega la 
lista de los diferentes archivos contenido en la referida ubicación, se selecciona el script: recon.sh. 
